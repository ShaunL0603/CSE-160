...
function makeKoalaFingys(rootCubeMat, LEFT) {
    ...
    fingyJoint1.matrix.translate(0.125 * g_koalaScaleX, -0.5 * g_koalaScaleY, 0.53 * g_koalaScaleZ);
    ...
    fingyJoint2.matrix.translate(0.125 * g_koalaScaleX, -0.96 * g_koalaScaleY, 0.53 * g_koalaScaleZ);
    ...
    fingyJoint3.matrix.translate(0.0, -1.3 * g_koalaScaleY, 0.43 * g_koalaScaleZ);
    ...
    fingyJoint4.matrix.translate(0.0, -1.3 * g_koalaScaleY, -0.07 * g_koalaScaleZ);
