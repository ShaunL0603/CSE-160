...
function makeKoalaArms(rootCubeMat) {
    ...
    leftShoulderJoint.matrix.translate(-0.22 * g_koalaScaleX, 0.0, -2.05 * g_koalaScaleZ);
    ...
    leftHand.matrix.translate(-0.5 * g_koalaScaleX, -1.33 * g_koalaScaleY, -0.55 * g_koalaScaleZ);
    ...
    rightShoulderJoint.matrix.translate(-0.33 * g_koalaScaleX, 0.0, 1.83 * g_koalaScaleZ);
    ...
    rightHand.matrix.translate(-0.5 * g_koalaScaleX, -1.33 * g_koalaScaleY, -0.55 * g_koalaScaleZ);
