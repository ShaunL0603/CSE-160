function makeKoalaToes(rootCubeMat, LEFT) {
    ...
    firstToe.matrix.translate(-0.2 * g_koalaScaleX,0.0 * g_koalaScaleY, -0.065 * g_koalaScaleZ);
    firstToe.matrix.scale(0.5 * g_koalaScaleX, 0.45 * g_koalaScaleY, 0.2 * g_koalaScaleZ);
    firstToe.render();

    var firstToe2 = new Cube();
    firstToe2.color = g_koalaGreyColorMat;
    firstToe2.matrix = new Matrix4(thumbBone2Mat);
    firstToe2.matrix.translate(-0.2 * g_koalaScaleX, 0.0 * g_koalaScaleY, -0.065 * g_koalaScaleZ);
    firstToe2.matrix.scale(0.5 * g_koalaScaleX, 0.45 * g_koalaScaleY, 0.2 * g_koalaScaleZ);
    firstToe2.render();
    ...
    fingyJoint2.matrix.translate(0.5 * g_koalaScaleX, 0.1 * g_koalaScaleY, 1.0 * g_koalaScaleZ);
    ...
    thumbJoint1.matrix.translate(0.0, 0.0, 0.5 * g_koalaScaleZ);
    thumbJoint1.matrix.rotate(rotateToe2 * 1.5, 0, 1, 0);
    var thumbJoint1Mat = new Matrix4(thumbJoint1.matrix);
    thumbJoint1.matrix.scale(g_koalaScaleX * 0.25, g_koalaScaleY * 0.125, g_koalaScaleZ * 0.125);
    thumbJoint1.matrix.translate(-0.5, 0.0, -0.5);
    thumbJoint1.render();
    ...
    thumbJoint2.matrix.translate(0.0, 0.0, 0.5 * g_koalaScaleZ);
    ...
    secondThumbBone3.matrix.translate(-0.07 * g_koalaScaleX, 0.03 * g_koalaScaleY, 0.06 * g_koalaScaleZ);
    var secondThumbBone3Mat = new Matrix4(secondThumbBone3.matrix);
    secondThumbBone3.matrix.scale(g_koalaScaleX * 0.125, g_koalaScaleY * 0.0625, g_koalaScaleZ * 0.4);
    ...
    fingyJoint3.matrix.translate(0.5 * g_koalaScaleX, 0.15 * g_koalaScaleY, 1.3 * g_koalaScaleZ);
    ...
    fourthToe.matrix.translate(-0.2 * g_koalaScaleX,0.0 * g_koalaScaleY, -0.065 * g_koalaScaleZ);
    fourthToe.matrix.scale(0.5 * g_koalaScaleX, 0.45 * g_koalaScaleY, 0.2 * g_koalaScaleZ);
    fourthToe.render();

    var fourthToe2 = new Cube();
    fourthToe2.color = g_koalaGreyColorMat;
    fourthToe2.matrix = new Matrix4(middleBone2Mat);
    fourthToe2.matrix.translate(-0.2 * g_koalaScaleX, 0.0 * g_koalaScaleY, -0.065 * g_koalaScaleZ);
    fourthToe2.matrix.scale(0.5 * g_koalaScaleX, 0.45 * g_koalaScaleY, 0.2 * g_koalaScaleZ);
    fourthToe2.render();

    var fourthToe3 = new Cube();
    fourthToe3.color = g_koalaGreyColorMat;
    fourthToe3.matrix = new Matrix4(middleBone3Mat);
    fourthToe3.matrix.translate(-0.2 * g_koalaScaleX, -0.01 * g_koalaScaleY, -0.065 * g_koalaScaleZ);
    fourthToe3.matrix.scale(0.5 * g_koalaScaleX, 0.45 * g_koalaScaleY, 0.2 * g_koalaScaleZ);
    fourthToe3.render();
