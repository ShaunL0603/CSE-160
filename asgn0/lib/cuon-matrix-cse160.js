...
class Vector3 {
    ...
    add(other) {
        ...
        {
          console.warn("Can't add a non-Vector3 to a Vector3");
          return this;
        }
    ...
    sub(other) {
        if (!(other instanceof Vector3))
        {
          console.warn("Can't subtract a non-Vector3 from a Vector3");
          return this;
        }
    ...
    div(scalar) {
        ...
        {
          console.warn(`Can't divide a Vector3 by a non-Number: ${scalar}`);
          return this;
        }
    ...
    static dot(other1, other2) {
        ...
        {
          console.warn("Can't calculate the dot product of non-Vector3s");
          return 0;
        }
